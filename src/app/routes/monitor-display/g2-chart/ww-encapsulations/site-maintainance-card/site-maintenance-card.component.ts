...
@Component({
  selector: 'ww-site-maintenance-card',
  templateUrl: './site-maintenance-card.component.html',
})
export class MonitorDisplaySiteMaintenanceCardComponent implements OnInit {
